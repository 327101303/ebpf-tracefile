...
build:
	...
	clang -D__KERNEL__ -D__ASM_SYSREG_H \
		...
		-o - | llc -march=bpf -filetype=obj -o "${DEST_DIR}/ctrace.bpf.o"
	go-bindata -pkg ctrace -prefix "${DEST_DIR}/" -modtime 1 -o "${DEST_DIR}/ctrace.bpf.go" "${DEST_DIR}/ctrace.bpf.o"
