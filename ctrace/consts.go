...
// EventsNameToID holds all the events that ctrace can trace, indexed by their Name
var EventsNameToID map[string]int32

// essentialEvents is a list of event ids (in EventsIDToEvent map) that are essential to the operation of ctrace and therefore must be traced
